...
def kat_index():
    ...
    if plugin.get_setting("porn", bool):
        cats += [
            {"label": "Porn", "path": plugin.url_for("kat_porn")},
        ]
    return cats
...
def kat_movies():
    return [
        ...
        {"label": "    in 1080p", "path": plugin.url_for("kat_search", query="720p category:movies", sort_field="time_add", sort_order="desc", content_type="movies")},
...
def kat_anime():
    return [
        {"label": "Search Anime", "path": plugin.url_for("kat_search", query_suffix="category:anime", sort_field="seeders", sort_order="desc", content_type="movies")},
        {"label": "All Anime", "path": plugin.url_for("kat_page", root="anime", page=1, sort_field="seeders", sort_order="desc", content_type="episodes")},
        {"label": "    HD", "path": plugin.url_for("kat_search", query="(1080p OR 720p) category:anime", sort_field="seeders", sort_order="desc", content_type="episodes")},
        {"label": "    720p", "path": plugin.url_for("kat_search", query="720p category:anime", sort_field="seeders", sort_order="desc", content_type="episodes")},
        {"label": "    1080p", "path": plugin.url_for("kat_search", query="1080p category:anime", sort_field="seeders", sort_order="desc", content_type="episodes")},
    ]
...
def kat_porn():
    return [
        {"label": "Porn", "path": plugin.url_for("kat_page", root="xxx", page=1, sort_field="seeders", sort_order="desc", content_type="episodes")},
        {"label": "    HD", "path": plugin.url_for("kat_page", root="xxx-hd-video", page=1, sort_field="seeders", sort_order="desc", content_type="episodes")},
        {"label": "    Hentai", "path": plugin.url_for("kat_page", root="hentai", page=1, sort_field="seeders", sort_order="desc", content_type="episodes")},
    ]
...
def kat_search():
    ...
    if query:
        plugin.redirect(plugin.url_for("kat_page", root="usearch/%s/" % urllib.quote("%s %s verified:1" % (query, suffix)), page=1, **plugin.request.args_dict))
