...
def rutor_play(tid):
    ...
    from xbmctorrent.utils import first, url_get, SafeDialogProgress, get_quality_from_name, get_current_list_item
    ...
    with closing(SafeDialogProgress(delay_close=0)) as dialog:
        ...
        if "files" in metadata["info"] and ace_supported():
            ...
            if plugin.get_setting("force_ace", bool) and ace_supported():
                ...
                current_item["path"] = plugin.url_for("play", uri=generate_magnet(metadata, name))
