...
def url_get(url, params={}, headers={}, post = None):
    ...
    from xbmctorrent.antizapret import url_get as url_get_origin
    ...
    if not _cookiejar:
        ...
        if plugin.get_setting("immunicity", bool):
            urllib2.install_opener(urllib2.build_opener(AntizapretProxyHandler(), cookie_handler))
        else:
