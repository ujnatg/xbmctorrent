...
def bitsnoop_search():
    ...
    if query:
        plugin.redirect(plugin.url_for("bitsnoop_page", root="/search/video/%s/c/d/" % urllib.quote("%s safe:no" % query), page=1, **plugin.request.args_dict))
